...
def OOoo ( list = False , mini = None , server = None , share = False , simple = False , src = None , timeout = 10 , units = ( 'bit' , 8 ) , version = False ) :
 ...
 if not simple :
  ...
  try :
   ...
   oo0 [ 0 ] = oo0 [ 1 ]
   oo0 [ 1 ] = oo0 [ 2 ]
   oo0 [ 2 ] = ( 'Hosted by %(sponsor)s (%(name)s) [%(d)0.2f km]: %(latency)s ms' % IIIIiIiIi1 ) . encode ( 'utf-8' , 'ignore' )
...
class i11iI11iIiIi ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  ...
  oO0oO0 . ok ( "Result Saved!" , "Brought to you by teamxkodi" )
  self . close ( )
...
class oO ( xbmcgui . Window ) :
 ...
 def buildElements ( self ) :
  ...
  self . imgProgress = xbmcgui . ControlImage ( 340 , 640 , 600 , 20 , self . image_progress , aspectRatio = 0 , colorDiffuse = "0xFF00AACC" )
  ...
  self . button_run_glow = xbmcgui . ControlImage ( iiIIIiIi1IIi , ii11i , oooO0 , iiIIiii , self . image_button_run_glow , aspectRatio = 0 )
  ...
  OOoO000 = 50
  self . imgResults = xbmcgui . ControlImage ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , self . image_speedtestresults , aspectRatio = 0 )
  ...
  self . imgPing_glow = xbmcgui . ControlImage ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , self . image_ping_glow , aspectRatio = 1 )
  ...
  self . imgGauge = xbmcgui . ControlImage ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , self . image_gauge , aspectRatio = 0 )
  self . imgGauge_arrow = xbmcgui . ControlImage ( oOoo000 , OooOo00o , ooo000o0ooO0 , I1I , self . image_gauge_arrow , aspectRatio = 0 )
  ...
  self . please_wait_textbox = xbmcgui . ControlLabel ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , label = 'Please wait...' , textColor = '0xFFFFFFFF' , alignment = 2 | 4 )
  ...
  OOoO000 = 102
  self . ping_textbox = xbmcgui . ControlLabel ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , label = '' , textColor = '0xFFFFFFFF' )
  ...
  OOoO000 = 102
  self . dl_textbox = xbmcgui . ControlLabel ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , label = '' , textColor = '0xFFFFFFFF' )
  ...
  OOoO000 = 102
  self . ul_textbox = xbmcgui . ControlLabel ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , label = '' , textColor = '0xFFFFFFFF' )
  ...
  self . dlul_prog_textbox = xbmcgui . ControlLabel ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , label = '' , textColor = '0xFFFFFFFF' , font = 'font30' , alignment = 2 | 4 )
  ...
  self . button_close = xbmcgui . ControlButton ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , "[B]Close[/B]" , focusTexture = self . image_button_run , noFocusTexture = self . image_button_run , alignment = 2 | 4 , textColor = '0xFF000000' , focusedColor = '0xFF000000' , shadowColor = '0xFFCCCCCC' )
 ...
 def showResult ( self ) :
  ...
  iiI11 = ( self . screenx / 3 ) - ( oOo00O000Oo0 / 2 )
  OOoO000 = ( self . screeny / 3 ) - ( I1iI1I1I1i11i / 2 ) + 50
  self . imgFinalResults = xbmcgui . ControlImage ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , self . image_result , aspectRatio = 0 )
  self . addControl ( self . imgFinalResults )
  self . imgFinalResults . setVisible ( False )
  self . imgFinalResults . setAnimations ( [
 ( 'conditional' , 'effect=fade start=0 end=100 delay=2000 time=3000 condition=Control.IsVisible(%d)' % self . imgFinalResults . getId ( ) )
 ] )
 ...
 ( 'conditional' , 'effect=fade start=0 end=100 delay=1000 time=1000 condition=Control.IsVisible(%d)' % self . imgPing . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 condition=!Control.IsEnabled(%d)' % self . imgPing . getId ( ) )
 ] )
  self . imgPing_glow . setAnimations ( [
 ( 'conditional' , 'effect=fade start=0 time=1000 pulse=true condition=Control.IsEnabled(%d)' % self . imgPing_glow . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=0 end=100 delay=1000 time=1000 condition=Control.IsVisible(%d)' % self . imgPing_glow . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 condition=!Control.IsEnabled(%d)' % self . imgPing_glow . getId ( ) )
 ] )
  self . imgGauge . setAnimations ( [
 ( 'conditional' , 'effect=fade start=0 end=100 delay=1000 time=1000 condition=Control.IsVisible(%d)' % self . imgGauge . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 condition=!Control.IsEnabled(%d)' % self . imgGauge . getId ( ) )
 ] )
  self . imgGauge_arrow . setAnimations ( [
 ( 'conditional' , 'effect=fade start=0 end=100 time=1000 condition=Control.IsVisible(%d)' % self . imgGauge_arrow . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 condition=!Control.IsEnabled(%d)' % self . imgGauge_arrow . getId ( ) )
 ] )
  self . imgProgress . setAnimations ( [
 ( 'conditional' , 'effect=fade start=0 end=100 time=500 condition=Control.IsVisible(%d)' % self . imgProgress . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 condition=!Control.IsEnabled(%d)' % self . imgProgress . getId ( ) )
 ] )
 ...
 ( 'conditional' , 'effect=fade start=0 end=100 delay=2000 time=3000 condition=Control.IsVisible(%d)' % self . imgResults . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 condition=!Control.IsEnabled(%d)' % self . imgResults . getId ( ) )
 ] )
  self . button_run . setAnimations ( [
 ( 'conditional' , 'effect=fade time=3000 condition=Control.IsVisible(%d)' % self . button_run_glow . getId ( ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 condition=!Control.IsEnabled(%d)' % self . button_run . getId ( ) )
 ] )
 ...
 ( 'conditional' , 'effect=fade start=0 end=100 delay=300 time=1000 condition=Control.IsVisible(%d)' % self . button_close . getId ( ) )
 ] )
 ...
 def configGauge ( self , speed , last_speed = 0 , time = 1000 ) :
  ...
  if speed <= 1 :
   ...
   IIi11IIiIii1 = iIii - float ( ( float ( speed ) - float ( iII11I1Ii1 ) ) ) * float ( ( float ( o0o0oOo0oO ) / float ( oOo0OoOOo0 ) ) )
  elif speed <= 2 :
   I1iIII1 = 59
   iIii = 90
   oOo0OoOOo0 = 1
   ...
   iII11I1Ii1 = 10
   o0o0oOo0oO = ( iIii - I1iIII1 )
   IIi11IIiIii1 = I1iIII1 + float ( ( float ( speed ) - float ( iII11I1Ii1 ) ) ) * float ( ( float ( o0o0oOo0oO ) / float ( oOo0OoOOo0 ) ) )
  elif speed <= 30 :
   I1iIII1 = 59
   iIii = 90
   oOo0OoOOo0 = 10
  ...
  self . imgGauge_arrow . setAnimations ( [
 ( 'conditional' , 'effect=rotate start=%d end=%d center=%d,%d condition=Control.IsVisible(%d) time=%d' % ( int ( last_speed ) , int ( IIi1IIIIi ) , oOoo000 , OooOo00o , self . imgGauge . getId ( ) , time ) )
 ] )
  return IIi1IIIIi
 ...
 def displayAdvertisement ( self ) :
  ...
  self . imgAdvertisement = xbmcgui . ControlImage ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , Oo000ooOOO , aspectRatio = 0 )
  self . addControl ( self . imgAdvertisement )
  self . imgAdvertisement . setVisible ( False )
  self . imgAdvertisement . setAnimations ( [
 ( 'conditional' , 'effect=slide start=%d time=1000 tween=cubic easing=in delay=2000 condition=Control.IsVisible(%d)' % ( oOo00O000Oo0 + 30 , self . imgAdvertisement . getId ( ) ) ) ,
 ( 'WindowClose' , 'effect=slide end=%d time=1000 tween=cubic easing=in condition=Control.IsVisible(%d)' % ( oOo00O000Oo0 + 30 , self . imgAdvertisement . getId ( ) ) ) ] )
 ...
 def onControl ( self , control ) :
  if control == self . button_run :
   ...
   self . imgAdvertisement . setVisible ( True )
 ...
 'id' : 0
  ...
  if not simple :
   ...
   try :
    unicode ( )
    oo0 . append ( ( 'Hosted by %(sponsor)s (%(name)s) [%(d)0.2f km]: %(latency)s ms' % IIIIiIiIi1 ) . encode ( 'utf-8' , 'ignore' ) )
    self . update_textbox ( oo0 )
    Ii11iI1i ( ( 'Hosted by %(sponsor)s (%(name)s) [%(d)0.2f km]: '
 '%(latency)s ms' % IIIIiIiIi1 ) . encode ( 'utf-8' , 'ignore' ) )
   except NameError :
...
#ii1ii11 = base64 . b64decode ( 'aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcvR3dqTHZCRlc=' )
if 97 - 97: OoooooooOO - o0ooo
#oooo00 = base64 . b64decode ( 'aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcvR3dqTHZCRlc=' )
...
class oooo00i1 ( object ) :
 def __init__ ( self , video_url ) :
  ...
  if 'http://www.youtube.com/watch?v' in parse_qs ( video_url ) . keys ( ) :
   ...
   ooooOooo0 = 'https://www.youtube.com/get_video_info?video_id=' + parse_qs ( video_url ) [ 'https://www.youtube.com/watch?v' ] [ 0 ]
...
class oO0ooOO ( xbmcgui . WindowXMLDialog ) :
 ...
 ( 'conditional' , 'effect=fade start=0 time=1000 delay=2000 pulse=true condition=Control.IsVisible(%d)' % self . button_close_glow . getId ( ) )
 ] )
   if 35 - 35: i1IIi - o0oOOo0O0Ooo * o0oOoO00o
   self . button_close = xbmcgui . ControlButton ( 99999 , 99999 , o0o0oOO , i1IiI , "[B]Close[/B]" , focusTexture = self . image_button_run , noFocusTexture = self . image_button_run , alignment = 2 | 4 , textColor = '0xFF000000' , focusedColor = '0xFF000000' , shadowColor = '0xFFCCCCCC' )
   self . addControl ( self . button_close )
   self . button_close . setVisible ( False )
   self . button_close . setPosition ( i1I1i , OO0o )
   self . button_close_ID = self . button_close . getId ( )
   self . button_close . setAnimations ( [
 ( 'conditional' , 'effect=fade start=0 end=100 delay=1000 time=1000 condition=Control.IsVisible(%d)' % self . button_close . getId ( ) )
 ] )
 ...
 ( 'conditional' , 'effect=slide start=%d time=2000 delay=50 tween=linear easing=in condition=Control.IsVisible(%d)' % ( oOo00O000Oo0 + 50 , self . imgResults . getId ( ) ) ) ,
 ( 'conditional' , 'effect=fade start=100 end=0 time=300 delay=1000 condition=!Control.IsEnabled(%d)' % self . imgResults . getId ( ) )
 ] )
   self . imgResults . setVisible ( True )
 ...
 ( 'conditional' , 'effect=fade start=0 end=100 time=1000 delay=100 condition=Control.IsVisible(%d)' % self . imgFinalResults . getId ( ) ) ,
 ( 'conditional' , 'effect=zoom end=150 start=100 center=%s time=2000 delay=3000 condition=Control.IsVisible(%d)' % ( "auto" , self . imgFinalResults . getId ( ) ) ) ,
 ( 'conditional' , 'effect=slide end=-100,25 time=2000 delay=3000 tween=linear easing=in condition=Control.IsVisible(%d)' % self . imgFinalResults . getId ( ) )
 ] )
  self . imgFinalResults . setVisible ( True )
  self . imgFinalResults . setEnabled ( True )
  if 34 - 34: II1Ii1iI1i * OoOoOO00 - I11iii11IIi - I1IiiI - II1Ii1iI1i
 def displayAdvertisement ( self , function = "true" ) :
  if ( function == "true" ) :
   try :
    Oo000ooOOO = urlopen ( ii1ii11 ) . readline ( ) . strip ( ' \t\n\r' )
   except :
   ...
   iiI11 = iii1 - oOo00O000Oo0 - 30
   OOoO000 = I1i - I1iI1I1I1i11i - 20
   if 42 - 42: II111iiii * I1IiiI % i1IIi - II1Ii1iI1i % I11iii11IIi
   self . imgAdvertisement_shadow = xbmcgui . ControlImage ( iiI11 - 3 , OOoO000 - 3 , oOo00O000Oo0 + 6 , I1iI1I1I1i11i + 6 , '' , aspectRatio = 0 )
   self . addControl ( self . imgAdvertisement_shadow )
   self . imgAdvertisement_shadow . setVisible ( False )
   self . imgAdvertisement_shadow . setImage ( self . image_shadow )
   self . imgAdvertisement_shadow . setAnimations ( [
 ( 'conditional' , 'effect=slide start=%d time=1490 tween=linear easing=in condition=Control.IsVisible(%d)' % ( oOo00O000Oo0 + 30 , self . imgAdvertisement_shadow . getId ( ) ) ) ,
 ( 'conditional' , 'effect=slide end=%d time=1000 tween=cubic easing=in condition=!Control.IsEnabled(%d)' % ( oOo00O000Oo0 + 30 , self . imgAdvertisement_shadow . getId ( ) ) ) ] )
   if 36 - 36: i11iIiiIii / oooO0oo0oOOOO * I1ii11iIi11i * I1ii11iIi11i + II1Ii1iI1i * i111I
   self . imgAdvertisement = xbmcgui . ControlImage ( iiI11 , OOoO000 , oOo00O000Oo0 , I1iI1I1I1i11i , '' , aspectRatio = 0 )
   self . addControl ( self . imgAdvertisement )
   self . imgAdvertisement . setVisible ( False )
   self . imgAdvertisement . setImage ( Oo000ooOOO )
   self . imgAdvertisement . setAnimations ( [
 ( 'conditional' , 'effect=slide start=%d time=1490 tween=linear easing=in condition=Control.IsVisible(%d)' % ( oOo00O000Oo0 + 30 , self . imgAdvertisement . getId ( ) ) ) ,
 ( 'conditional' , 'effect=slide end=%d time=1000 tween=cubic easing=in condition=!Control.IsEnabled(%d)' % ( oOo00O000Oo0 + 30 , self . imgAdvertisement . getId ( ) ) ) ] )
   if 32 - 32: OoO0O00
   self . imgAdvertisement_shadow . setVisible ( True )
   self . imgAdvertisement . setVisible ( True )
   return Oo000ooOOO
  elif ( function == "visible" ) :
   self . imgAdvertisement_shadow . setEnabled ( True )
   self . imgAdvertisement_shadow . setVisible ( True )
   self . imgAdvertisement . setEnabled ( True )
   self . imgAdvertisement . setVisible ( True )
  else :
   self . imgAdvertisement_shadow . setEnabled ( False )
   self . imgAdvertisement . setEnabled ( False )
   if 50 - 50: OOO0O + i1IIi
 def playVideo ( self , function = "true" ) :
  self . videowindow = self . getControl ( 23 )
  if xbmc . getCondVisibility ( 'System.HasAddon(script.system.settings)' ) and xbmcaddon . Addon ( id = "script.system.settings" ) . getSetting ( "OEM_DIST" ) in [ "ARNU BOX" , "MBOX" ] : i11IiIIi11I = True ; self . analytics_video = "ARNU Box - No video played" ;
  else : i11IiIIi11I = False ;
 ...
 def onClick ( self , control ) :
  if control == self . button_run_ID :
   ...
   self . displayResults ( )
   Oo000ooOOO = self . displayAdvertisement ( )
   ...
   self . displayAdvertisement ( False )
 ...
 def saveClose ( self ) :
  ...
  if self . testRun :
   print ( "SpeedtestAddon-AdvertisementVideo" , str ( self . analytics_video ) + str ( IIi1iI ) )
   self . analytics . sendEvent2 ( "SpeedtestAddon-AdvertisementVideo" , str ( self . analytics_video ) , str ( IIi1iI ) )
   if 35 - 35: i11iIiiIii
 def update_textbox ( self , text ) :
  self . textbox . setText ( "\n" . join ( text ) )
 ...
 def speedtest ( self , list = False , mini = None , server = None , share = False , simple = False , src = None , timeout = 10 , units = ( 'bit' , 8 ) , version = False ) :
  self . imgPing . setVisible ( True )
  self . imgPing_glow . setVisible ( True )
  oo0 = [ 'Running Speed Tester - Brought to by teamxkodi' ]
  if 29 - 29: O0 . o0ooo
