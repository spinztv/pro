...
base='http://spez.tv'
ADDON=xbmcaddon.Addon(id='plugin.video.spinztvwiz')
...
def CATEGORIES():
    link = OPEN_URL('http://spez.tv/spinz/wizardtxt/regwiz.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dialog.ok("DOWNLOAD COMPLETE!!! :)", 'To ensure all changes are saved you must now close Kodi', 'Unplug your device from the Tv or Outlet and Restart.')
    killxbmc()
